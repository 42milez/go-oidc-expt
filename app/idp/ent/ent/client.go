...
func (c *AdminClient) UpdateOneID(id typedef.AdminID) *AdminUpdateOne {
...
func (c *AdminClient) DeleteOneID(id typedef.AdminID) *AdminDeleteOne {
...
func (c *AdminClient) Get(ctx context.Context, id typedef.AdminID) (*Admin, error) {
	return c.Query().Where(admin.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AdminClient) GetX(ctx context.Context, id typedef.AdminID) *Admin {
