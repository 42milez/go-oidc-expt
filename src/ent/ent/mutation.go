...
func (m *AccountMutation) SetModifiedAt(t time.Time) {
	m.modified_at = &t
}

// ModifiedAt returns the value of the "modified_at" field in the mutation.
func (m *AccountMutation) ModifiedAt() (r time.Time, exists bool) {
	v := m.modified_at
	if v == nil {
		return
	}
...
// OldModifiedAt returns the old "modified_at" field's value of the Account entity.
// If the Account object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AccountMutation) OldModifiedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AccountMutation) ResetModifiedAt() {
	m.modified_at = nil
}
...
func (m *AccountMutation) Fields() []string {
	...
	if m.modified_at != nil {
		fields = append(fields, account.FieldModifiedAt)
	}
	return fields
}
